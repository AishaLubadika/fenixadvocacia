...
import fenix.advocacia.dao.ejbs.UsuarioFacade;
import fenix.advocacia.modelo.entities.Usuario;
 ...
 * @author LUBADIKA
 */
@Named(value = "usuarioMdBean")
@SessionScoped
public class UsuarioMdBean implements Serializable {

    private static final long serialVersionUID = 1L;
    private Usuario usuario;
    private List<Usuario> usuarios;

    public UsuarioMdBean() {
    }
    ...
    public void edit(ActionEvent evt) {
        ...
        try {
            FacesContext.getCurrentInstance().getExternalContext().redirect("usuario_lisatar.jsf");

        } catch (IOException ex) {
            java.util.logging.Logger.getLogger(UsuarioMdBean.class.getName()).log(Level.SEVERE, null, ex);
